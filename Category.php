...
var categoriess = '<?php  echo $categoriess?>'
$(document).ready(function() {
	...
	$.ajax({
		url: "includes/handlers/ajax_category_posts.php",
		type: "POST",
		data: "page=1&userLoggedIn=" + userLoggedIn + "&categoriess=" + categoriess,
		cache:false,
	...
	//$('#load_more').on("click", function() {
		...
		//if (noMorePosts == 'false') {
			...
			var ajaxReq = $.ajax({
				url: "includes/handlers/ajax_category_posts.php",
				type: "POST",
				data: "page=" + page + "&userLoggedIn=" + userLoggedIn + "&category_id=" + category_id,
				cache:false,
